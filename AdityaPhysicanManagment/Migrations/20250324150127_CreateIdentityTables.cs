...
namespace AdityaPhysicanManagment.Migrations
{
    public partial class CreateIdentityTables : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Physicians", x => x.UserId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MedicalRecordId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AppointmentId = table.Column<int>(type: "int", nullable: false),
                    SymptomsReported = table.Column<string>(type: "nvarchar(max)", nullable: false),
